...
public class TestSqlFixture {
	...
	public void getClassesToDeleteReturnsEmptyListOfNotDefined() {
		// GIVEN
		SqlFixture fixture = new SqlFixture("classpath:tests/fixtures/sql-fixture.sql");
	...
	public void getClassesToDeleteReturnsCorrectSetIfDefined() {
		// GIVEN
		SqlFixture fixture = new SqlFixture("classpath:tests/fixtures/sql-fixture.sql", User.class, Product.class);
	...
	@Test
	public void loadExecutresQueriesLineByLine() {
		// GIVEN
		SqlFixture fixture = new SqlFixture("classpath:tests/fixtures/sql-fixture.sql", User.class, Product.class);
