 ...
 */
public class JixtureTestExecutionListenerCleanupHandler extends BaseJixtureTestExecutionListenerWriteHandler {
	@Override
	protected List<FixtureDef> parseJixtureAnnotation(Jixture jixtureAnnotation) {
		if (null != jixtureAnnotation) {
			return Arrays.asList(jixtureAnnotation.cleanup());
		}
